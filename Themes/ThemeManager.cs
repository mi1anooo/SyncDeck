...
public class ThemeManager
{
    public static readonly IReadOnlyList<ThemeDefinition> All = new List<ThemeDefinition>
    {
        ...
        {
            Id              = "SonyChrome",
            DisplayName     = "Sony Chrome",
            Background      = Color.Parse("#0D0D12"),
            SurfacePrimary  = Color.Parse("#1A1A22"),
            SurfaceSecondary= Color.Parse("#22222E"),
            FrameBorder     = Color.Parse("#4A4A5A"),
            AccentPrimary   = Color.Parse("#3CA0FF"),
            AccentSecondary = Color.Parse("#7AD0FF"),
            GlowColor       = Color.Parse("#3CA0FF"),
            GlowIntensity   = 8,
            TextPrimary     = Color.Parse("#E8EAF0"),
            TextSecondary   = Color.Parse("#8090A8"),
            TextLcd         = Color.Parse("#3CA0FF"),
            ButtonFill      = Color.Parse("#252535"),
            ButtonBorder    = Color.Parse("#5A6080"),
            ButtonHover     = Color.Parse("#3A3A50"),
            ProgressTrack   = Color.Parse("#1E2030"),
            ProgressFill    = Color.Parse("#3CA0FF"),
            ProgressHandle  = Color.Parse("#7AD0FF"),
            VisualizerPrimary   = Color.Parse("#3CA0FF"),
            VisualizerSecondary = Color.Parse("#0A3060"),
            VisualizerStyle     = "minidisc",
            CornerRadius        = 10,
            InnerCornerRadius   = 5,
        },
